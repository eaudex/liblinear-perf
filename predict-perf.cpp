...
void do_predict(FILE *input, FILE *output)
{
	...
	while(readline(input) != NULL)
	{
        ...
        // store for evaluation metric
        pred_labels.push_back(predict_label);
        true_labels.push_back(target_label);
	}
	...
	{
        validation_function_regression(pred_labels, true_labels);
    }
    else
    {
        validation_function(pred_labels, true_labels);
    }
